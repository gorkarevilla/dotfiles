# Generated by Powerlevel10k configuration wizard on 2026-02-17 at 20:50 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    host                    # hostname
    dir_writable            # directory writability indicator
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    ssh                     # ssh indicator (custom segment - needs to be added)
  ...
  # Custom colors for different directory states (from .zshrc)
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_BACKGROUND=cyan
  typeset -g POWERLEVEL9K_DIR_DEFAULT_FOREGROUND=black
  typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_BACKGROUND=cyan
  typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_FOREGROUND=black
  ...
  ####################################[ host: hostname ]########################################
  # Host colors (from .zshrc)
  typeset -g POWERLEVEL9K_HOST_LOCAL_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_HOST_LOCAL_BACKGROUND=235
  typeset -g POWERLEVEL9K_HOST_REMOTE_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_HOST_REMOTE_BACKGROUND=235
  # Host icon
  if [[ $OSTYPE = (darwin|freebsd)* ]]; then
  ...
  typeset -g POWERLEVEL9K_HOST_ICON_FOREGROUND=red
  typeset -g POWERLEVEL9K_HOST_ICON_BACKGROUND=black

  ####################################[ ssh: SSH indicator ]####################################
  # SSH segment colors (from .zshrc)
  typeset -g POWERLEVEL9K_SSH_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_SSH_BACKGROUND=235
  typeset -g POWERLEVEL9K_SSH_ICON=$'\uF489'  #

  ###################################[ user: username ]#########################################
  # User colors (from .zshrc)
  typeset -g POWERLEVEL9K_USER_DEFAULT_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_USER_DEFAULT_BACKGROUND=235
  typeset -g POWERLEVEL9K_USER_ROOT_FOREGROUND=red
  typeset -g POWERLEVEL9K_USER_ROOT_BACKGROUND=235
  typeset -g POWERLEVEL9K_USER_ICON=$'\uF415'  #

  ###############################[ root_indicator: root status ]################################
  # Root indicator colors (from .zshrc)
  typeset -g POWERLEVEL9K_ROOT_INDICATOR_FOREGROUND=red
  typeset -g POWERLEVEL9K_ROOT_INDICATOR_BACKGROUND=235
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=020
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=white
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=purple
  ...
  # Custom wifi_signal segment (from .zshrc)
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SIGNAL="zsh_wifi_signal"
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SIGNAL_BACKGROUND="235"
