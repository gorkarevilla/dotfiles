...
POWERLEVEL10K_SHORTEN_STRATEGY="truncate_left"

#POWERLEVEL10K_DIR_PATH_SEPARATOR="%F{cyan}\/%F{blue}"
#POWERLEVEL10K_DIR_PATH_SEPARATOR="%F{grey}\/%F{white}"
#POWERLEVEL10K_DIR_PATH_SEPARATOR="%F{white}\/%F{grey}"
#POWERLEVEL10K_DIR_PATH_SEPARATOR="%F{235}\/%F{235}"
POWERLEVEL10K_DIR_OMIT_FIRST_CHARACTER=false
...
#POWERLEVEL10K_MULTILINE_FIRST_PROMPT_PREFIX="%F{cyan}\u256D\u2500%f"
#POWERLEVEL10K_MULTILINE_LAST_PROMPT_PREFIX="%F{grey}\u2570\uF460%f "

POWERLEVEL10K_MULTILINE_FIRST_PROMPT_PREFIX=$'%F{cyan}\u256D\u2500%f'
POWERLEVEL10K_MULTILINE_LAST_PROMPT_PREFIX=$'%F{014}\u2570%F{cyan}\uF460%F{073}\uF460%F{109}\uF460%f '

#POWERLEVEL10K_MULTILINE_LAST_PROMPT_PREFIX="%F{grey}\uF460%f "
#POWERLEVEL10K_MULTILINE_LAST_PROMPT_PREFIX="%K{clear}%F{cyan}%m%f%k %F{123}\uF460%f "

POWERLEVEL10K_STATUS_VERBOSE=false
POWERLEVEL10K_PROMPT_ADD_NEWLINE=true

POWERLEVEL10K_CUSTOM_WIFI_SIGNAL="zsh_wifi_signal"
POWERLEVEL10K_CUSTOM_WIFI_SIGNAL_BACKGROUND="235"

#POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(root_indicator host dir_writable dir vcs)
POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(host dir_writable dir vcs)
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(command_execution_time background_jobs ssh status time virtualenv kubecontext)

#POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(ssh context root_indicator time_joined dir_joined dir_writable_joined vcs)
#POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time background_jobs anaconda pyenv virtualenv rbenv rvm nodeenv nvm time)

#POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(root_indicator time_joined
#                                   dir_joined dir_writable_joined)
#POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time vcs
...
POWERLEVEL10K_DIR_WRITABLE_FORBIDDEN_BACKGROUND="cyan"
POWERLEVEL10K_DIR_WRITABLE_FORBIDDEN_FOREGROUND="black"

POWERLEVEL10K_ROOT_INDICATOR_BACKGROUND="235"
POWERLEVEL10K_ROOT_INDICATOR_FOREGROUND="red"
POWERLEVEL10K_STATUS_OK_BACKGROUND="235"
POWERLEVEL10K_STATUS_OK_FOREGROUND="green"
POWERLEVEL10K_STATUS_ERROR_BACKGROUND="235"
POWERLEVEL10K_STATUS_ERROR_FOREGROUND="red"

POWERLEVEL10K_TIME_FORMAT="%D{\uf017 %T}" #  15:29:33
POWERLEVEL10K_TIME_FOREGROUND="cyan"
POWERLEVEL10K_TIME_BACKGROUND="235"

POWERLEVEL10K_VCS_GIT_GITHUB_ICON="\uf408" # 
POWERLEVEL10K_VCS_GIT_BITBUCKET_ICON=""
POWERLEVEL10K_VCS_GIT_GITLAB_ICON=""
POWERLEVEL10K_VCS_GIT_ICON=""

#POWERLEVEL10K_SSH_FOREGROUND="226"
POWERLEVEL10K_SSH_FOREGROUND="yellow"
POWERLEVEL10K_SSH_BACKGROUND="235"

POWERLEVEL10K_COMMAND_EXECUTION_TIME_BACKGROUND="235"
POWERLEVEL10K_COMMAND_EXECUTION_TIME_FOREGROUND="magenta"
POWERLEVEL10K_COMMAND_EXECUTION_TIME_ICON="\u231A"

POWERLEVEL10K_BACKGROUND_JOBS_BACKGROUND="235"
POWERLEVEL10K_BACKGROUND_JOBS_FOREGROUND="magenta"
POWERLEVEL10K_USER_DEFAULT_BACKGROUND="235"
POWERLEVEL10K_USER_DEFAULT_FOREGROUND="cyan"
POWERLEVEL10K_USER_ROOT_BACKGROUND="235"
POWERLEVEL10K_USER_ROOT_FOREGROUND="red"
POWERLEVEL10K_USER_ICON="\uF415" # 
POWERLEVEL10K_ROOT_ICON="\u26A1" # ⚡

POWERLEVEL10K_HOST_LOCAL_BACKGROUND="235"
POWERLEVEL10K_HOST_LOCAL_FOREGROUND="cyan"
POWERLEVEL10K_HOST_REMOTE_BACKGROUND="235"
POWERLEVEL10K_HOST_REMOTE_FOREGROUND="cyan"

POWERLEVEL10K_KUBECONTEXT_BACKGROUND="purple"
POWERLEVEL10K_KUBECONTEXT_FOREGROUND="white"

POWERLEVEL10K_VIRTUALENV_BACKGROUND="white"
POWERLEVEL10K_VIRTUALENV_FOREGROUND="020"

if [[ $OSTYPE = (darwin|freebsd)* ]]; then
    POWERLEVEL10K_HOST_ICON="\uF302" # 
else
    POWERLEVEL10K_HOST_ICON="\uF31b" # 
fi

POWERLEVEL10K_HOST_ICON_FOREGROUND="red"
POWERLEVEL10K_HOST_ICON_BACKGROUND="black"
POWERLEVEL10K_SSH_ICON="\uF489"  # 

POWERLEVEL10K_OS_ICON_BACKGROUND="235"
POWERLEVEL10K_OS_ICON_FOREGROUND="cyan"
